...
export default function BasketPage() {
    ...
    if (!basket) return <Typography variant="h3">Your Basket is empty</Typography> //if basket is null
                    ...
                    <TableBody>
                        {basket.items.map(item => (
                            ...
                            >
                                ...
                                <TableCell align="right">{item.price} Toman</TableCell>
                                ...
                                <TableCell align="right">{(item.price * item.quantity)} Toman</TableCell>
